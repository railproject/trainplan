...
public class DateUtil {
	...
	public static Date parseDate(String strDate)  {
		Date date = null;
		try {
			date =  StringUtils.isBlank(strDate) ? null : parseDate(strDate,defaultDatePattern);
	...
	public static Date parse(String strDate)  {
		Date date = null;
		try {
			date =  StringUtils.isBlank(strDate) ? null : parseDate(strDate,defaultDatePattern1);
		} catch (ParseException e) {
	...
	public static String getDateByDay(String strDate,int day){
		...
		String startTime = "";
		try {
			data = StringUtils.isBlank(strDate) ? null : sdf.parse(strDate);
