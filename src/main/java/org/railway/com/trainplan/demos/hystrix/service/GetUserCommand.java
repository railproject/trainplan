 ...
 *******************************************************************************/
package org.railway.com.trainplan.demos.hystrix.service;
...
public class GetUserCommand extends HystrixCommand<UserDTO> {
	...
	protected UserDTO run() throws Exception {
		try {
			...
			return restTemplate.getForObject("http://localhost:8080/trainplan/hystrix/resource/{id}", UserDTO.class, id);
