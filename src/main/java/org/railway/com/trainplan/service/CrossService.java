...
//		Class[] clazzes = method.getParameterTypes();
		...
		try {
			Constructor cs = Integer.class.getConstructor(String.class);
			
			System.out.println(Integer.class == Integer.class);
			try {
				System.out.println(cs.newInstance("1"));
	...
	public void actionExcel1(InputStream inputStream) {
...
//			}
	...
	private ArrayList<CrossTrainInfo> createTrainsForCross(CrossInfo cross){
...
//			webResource.method(this.method, GenericType)
			...
			JSONObject scheduleDto = obj.getJSONArray("data").getJSONObject(0).getJSONObject("scheduleDto");
