		 ...
		 var isChrome = navigator.userAgent.toLowerCase().match(/chrome/) != null;	
		  var Content_frame = function() {	
		   var WH = $(window).height();
			 if (isChrome) {
				 TargetBox.css({ "height": (WH - headerH) - 50 + "px"});
				 TargetBox.css({ "min-height": (WH - headerH) - 50 + "px"});

			}else{
				TargetBox.css({ "height": (WH - headerH) - 55 + "px"});
				TargetBox.css({ "min-height": (WH - headerH) - 55 + "px"});
				}		
		  };
		  TargetBox.attr("src","http://10.1.186.116:8090/dashboard/kanban/kanban.html");
		  Content_frame();
    ...
    <div class="col-md-4 col-sm-4 col-xs-4 pull-right">
      <div class="btn-group pull-right" style="margin-top:15px;">
        ...
        <ul class="dropdown-menu" role="menu">
          ...
          <li class="divider"></li>
          <li><a href="index.html"><i class="fa fa-sign-out"></i> 退 出</a></li>
        </ul>
      </div>
      <!--btn-group--> 
    </div>
...
<div class="sidebar"> 
  ...
  <nav class="Navigation">
    <ul>
      <li>
      	<a href="http://10.1.186.116:8090/dashboard/kanban/kanban.html"  target="contentFrame" class="menu_one" style="cursor:default;"><i class="fa fa-list-ol"></i>计划看板 </a>
      </li>
      <li>
