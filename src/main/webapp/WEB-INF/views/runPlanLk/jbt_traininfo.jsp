		      	...
		      	<div class="row">
			      	<div class="pull-left">
		  				<div class="row">
					     	...
					     	<div class="row" style="width: 100%; margin-top: 5px;">
						  		<div class="form-group" style="float:left;margin-left:0px;margin-bottom:0;">
						  			<label for="exampleInputEmail3" class="control-label pull-left" style="margin-left:5px">始发局:&nbsp;</label> 
									<div class="pull-left">
							     	...
							     	<label for="exampleInputEmail3" class="control-label pull-left" style="margin-left:10px">终到局:&nbsp;</label> 
									<div class="pull-left">
										<select style="width:40px" id="input_cross_chart_id"
						  			...
						  			<label for="exampleInputEmail3" class="control-label pull-left" style="margin-left:10px"> 车次：&nbsp;</label>
						            <div class="pull-left">
